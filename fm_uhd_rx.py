...
# Title: Fm Uhd Rx
# Generated: Sun Nov 18 23:30:29 2018
...
class fm_uhd_rx(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "Fm Uhd Rx")
        Qt.QWidget.__init__(self)
        self.setWindowTitle("Fm Uhd Rx")
        ...
        self.settings = Qt.QSettings("GNU Radio", "fm_uhd_rx")
        ...
        self.rx_freq = rx_freq = 91.9
        self.bw = bw = 10e3
        self.audio_decim = audio_decim = samp_rate/audio_rate
        self.amp = amp = 0.125

        ##################################################
        # Blocks
        ##################################################
        self._rx_gain_range = Range(0, 76, 0.5, 10, 200)
        ...
        self._bw_range = Range(1e3, 20e3, 0.5e3, 10e3, 200)
        self._bw_win = RangeWidget(self._bw_range, self.set_bw, 'LPF BW', "counter_slider", float)
        self.top_grid_layout.addWidget(self._bw_win, 1, 1, 1, 1)
        for r in range(1, 2):
            self.top_grid_layout.setRowStretch(r, 1)
        for c in range(1, 2):
            self.top_grid_layout.setColumnStretch(c, 1)
        self._amp_range = Range(0, 2, 0.001, 0.125, 200)
        self._amp_win = RangeWidget(self._amp_range, self.set_amp, 'Amplitude', "counter_slider", float)
        self.top_grid_layout.addWidget(self._amp_win, 2, 1, 1, 1)
        for r in range(2, 3):
            self.top_grid_layout.setRowStretch(r, 1)
        for c in range(1, 2):
            self.top_grid_layout.setColumnStretch(c, 1)
        ...
        self.uhd_usrp_source_0.set_center_freq(2.43e9, 0)
        self.uhd_usrp_source_0.set_gain(rx_gain, 0)
        self.uhd_usrp_source_0.set_antenna('TX/RX', 0)
        self._rx_freq_range = Range(87.9, 107.9, 0.200, 91.9, 200)
        self._rx_freq_win = RangeWidget(self._rx_freq_range, self.set_rx_freq, 'Rx Freq (MHz)', "counter_slider", float)
        self.top_grid_layout.addWidget(self._rx_freq_win, 1, 0, 1, 1)
        for r in range(1, 2):
            self.top_grid_layout.setRowStretch(r, 1)
        for c in range(0, 1):
            self.top_grid_layout.setColumnStretch(c, 1)
        ...
        self.top_grid_layout.addWidget(self._qtgui_waterfall_sink_x_0_win, 4, 1, 1, 1)
        for r in range(4, 5):
            self.top_grid_layout.setRowStretch(r, 1)
        for c in range(1, 2):
            self.top_grid_layout.setColumnStretch(c, 1)
        ...
        self.qtgui_freq_sink_x_0_0.set_y_axis(-40, 20)
        ...
        for c in range(0, 1):
            self.top_grid_layout.setColumnStretch(c, 1)
        self.fft_filter_xxx_0 = filter.fft_filter_ccc(1, (firdes.low_pass_2(1000, samp_rate, 100e3, 15e3, 50)), 1)
        ...
        self.blocks_multiply_const_vxx_0_0 = blocks.multiply_const_vff((amp, ))
        ...
        self.connect((self.broadcast_fm_rx_0, 0), (self.blocks_multiply_const_vxx_0, 0))
        self.connect((self.broadcast_fm_rx_0, 1), (self.blocks_multiply_const_vxx_0_0, 0))
        self.connect((self.fft_filter_xxx_0, 0), (self.broadcast_fm_rx_0, 0))
    ...
    def set_samp_rate(self, samp_rate):
        ...
        self.fft_filter_xxx_0.set_taps((firdes.low_pass_2(1000, self.samp_rate, 100e3, 15e3, 50)))
    ...
    def set_bw(self, bw):
        self.bw = bw
        self.broadcast_fm_rx_0.set_bw(self.bw)
...
def main(top_block_cls=fm_uhd_rx, options=None):
    ...
    tb = top_block_cls()
    tb.start()
    tb.setStyleSheetFromFile('/home/prabhat/gokuprefix/share/gnuradio/themes/projector.qss')
    tb.show()
