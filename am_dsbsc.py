...
# Title: Am Dsbsc
# Generated: Mon Oct 22 15:57:13 2018
...
class am_dsbsc(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "Am Dsbsc")
        Qt.QWidget.__init__(self)
        self.setWindowTitle("Am Dsbsc")
        ...
        self.settings = Qt.QSettings("GNU Radio", "am_dsbsc")
        ...
        # Blocks
        ##################################################
        self._f_rf_range = Range(0, samp_rate/2, 100, 0, 200)
        self._f_rf_win = RangeWidget(self._f_rf_range, self.set_f_rf, 'f_rf', "counter_slider", float)
        self.top_grid_layout.addWidget(self._f_rf_win, 0, 1, 1, 1)
        for r in range(0, 1):
        ...
        for c in range(0, 1):
            self.top_grid_layout.setColumnStretch(c, 1)
        self.fir_filter_xxx_0 = filter.fir_filter_fcc(1, (firdes.low_pass_2(1, samp_rate, bw, 1e3, 50)))
        ...
        self.analog_sig_source_x_0 = analog.sig_source_c(samp_rate, analog.GR_COS_WAVE, f_rf, 1, 0)
    ...
    def set_samp_rate(self, samp_rate):
        ...
        self.fir_filter_xxx_0.set_taps((firdes.low_pass_2(1, self.samp_rate, self.bw, 1e3, 50)))
    ...
    def set_f_rf(self, f_rf):
        self.f_rf = f_rf
        self.analog_sig_source_x_0.set_frequency(self.f_rf)
...
def main(top_block_cls=am_dsbsc, options=None):
