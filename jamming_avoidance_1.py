...
# Title: Jamming Avoidance 1
# Generated: Mon Oct 22 16:03:33 2018
...
class jamming_avoidance_1(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "Jamming Avoidance 1")
        Qt.QWidget.__init__(self)
        self.setWindowTitle("Jamming Avoidance 1")
        ...
        self.settings = Qt.QSettings("GNU Radio", "jamming_avoidance_1")
        ...
        self.channel = channel = random.randint(-4, 4)
        ...
        self._channel_options = [0, 1, 2, 3, -1, -2, -3, -4]
        self._channel_labels = ['zero', 'one', 'two', 'three', 'four', 'five', 'six', 'seven']
        ...
        for label in self._channel_labels: self._channel_combo_box.addItem(label)
        ...
        self.top_grid_layout.addWidget(self._channel_tool_bar)
        ...
        self.analog_sig_source_x_0_0_0 = analog.sig_source_c(samp_rate*interp, analog.GR_COS_WAVE, 30e3*random.randint(-4, 4), 1, 0)
        self.analog_sig_source_x_0_0 = analog.sig_source_c(samp_rate*interp, analog.GR_COS_WAVE, 30e3*channel, 1, 0)
    ...
    def set_channel(self, channel):
        ...
        self._channel_callback(self.channel)
        self.analog_sig_source_x_0_0.set_frequency(30e3*self.channel)


def main(top_block_cls=jamming_avoidance_1, options=None):
